...
(define-instruction-set :avx2
  ...
  (:instructions
   ...
   (two-arg-u8.32-sat-    #:vpsubusb      (u8.32) (u8.32 u8.32)   :cost 2)
   ...
   (u8.16-sad             #:vpsadbw       (u64.4) (u8.16 u8.16)      :cost 1)
   (u8.32-sad             #:vpsadbw       (u64.4) (u8.32 u8.32)      :cost 1)
   (u8.16-alignr          #:vpalignr      (u8.16) (u8.16 u8.16 imm8) :cost 1)
   (u8.32-alignr          #:vpalignr      (u8.32) (u8.32 u8.32 imm8) :cost 1)
   ...
   (s8.16-sad             #:vpsadbw      (u64.4) (s8.16 s8.16)      :cost 1)
   (s8.32-sad             #:vpsadbw      (u64.4) (s8.32 s8.32)      :cost 1)
  ...
  (:loads
   (f32.4-ntload  #:vmovntdqa f32.4  f32vec f32-array f32.4-non-temporal-aref f32.4-non-temporal-row-major-aref   f32.4-non-temporal-sap-ref)
   (f64.2-ntload  #:vmovntdqa f64.2  f64vec f64-array f64.2-non-temporal-aref f64.2-non-temporal-row-major-aref   f64.2-non-temporal-sap-ref)
   (f32.8-ntload  #:vmovntdqa f32.8  f32vec f32-array f32.8-non-temporal-aref f32.8-non-temporal-row-major-aref   f32.8-non-temporal-sap-ref)
   (f64.4-ntload  #:vmovntdqa f64.4  f64vec f64-array f64.4-non-temporal-aref f64.4-non-temporal-row-major-aref   f64.4-non-temporal-sap-ref)
   (u8.16-ntload  #:vmovntdqa u8.16   u8vec  u8-array u8.16-non-temporal-aref u8.16-non-temporal-row-major-aref   u8.16-non-temporal-sap-ref)
   (u16.8-ntload  #:vmovntdqa u16.8  u16vec u16-array u16.8-non-temporal-aref u16.8-non-temporal-row-major-aref   u16.8-non-temporal-sap-ref)
   (u32.4-ntload  #:vmovntdqa u32.4  u32vec u32-array u32.4-non-temporal-aref u32.4-non-temporal-row-major-aref   u32.4-non-temporal-sap-ref)
   (u64.2-ntload  #:vmovntdqa u64.2  u64vec u64-array u64.2-non-temporal-aref u64.2-non-temporal-row-major-aref   u64.2-non-temporal-sap-ref)
   (s8.16-ntload  #:vmovntdqa s8.16   s8vec  s8-array s8.16-non-temporal-aref s8.16-non-temporal-row-major-aref   s8.16-non-temporal-sap-ref)
   (s16.8-ntload  #:vmovntdqa s16.8  s16vec s16-array s16.8-non-temporal-aref s16.8-non-temporal-row-major-aref   s16.8-non-temporal-sap-ref)
   (s32.4-ntload  #:vmovntdqa s32.4  s32vec s32-array s32.4-non-temporal-aref s32.4-non-temporal-row-major-aref   s32.4-non-temporal-sap-ref)
   (s64.2-ntload  #:vmovntdqa s64.2  s64vec s64-array s64.2-non-temporal-aref s64.2-non-temporal-row-major-aref   s64.2-non-temporal-sap-ref)
   (u8.32-ntload  #:vmovntdqa u8.32   u8vec  u8-array u8.32-non-temporal-aref  u8.32-non-temporal-row-major-aref  u8.32-non-temporal-sap-ref)
   (u16.16-ntload #:vmovntdqa u16.16 u16vec u16-array u16.16-non-temporal-aref u16.16-non-temporal-row-major-aref u16.16-non-temporal-sap-ref)
   (u32.8-ntload  #:vmovntdqa u32.8  u32vec u32-array u32.8-non-temporal-aref  u32.8-non-temporal-row-major-aref  u32.8-non-temporal-sap-ref)
   (u64.4-ntload  #:vmovntdqa u64.4  u64vec u64-array u64.4-non-temporal-aref  u64.4-non-temporal-row-major-aref  u64.4-non-temporal-sap-ref)
   (s8.32-ntload  #:vmovntdqa s8.32   s8vec  s8-array s8.32-non-temporal-aref  s8.32-non-temporal-row-major-aref  s8.32-non-temporal-sap-ref)
   (s16.16-ntload #:vmovntdqa s16.16 s16vec s16-array s16.16-non-temporal-aref s16.16-non-temporal-row-major-aref s16.16-non-temporal-sap-ref)
   (s32.8-ntload  #:vmovntdqa s32.8  s32vec s32-array s32.8-non-temporal-aref  s32.8-non-temporal-row-major-aref  s32.8-non-temporal-sap-ref)
   (s64.4-ntload  #:vmovntdqa s64.4  s64vec s64-array s64.4-non-temporal-aref  s64.4-non-temporal-row-major-aref  s64.4-non-temporal-sap-ref))
  (:stores
