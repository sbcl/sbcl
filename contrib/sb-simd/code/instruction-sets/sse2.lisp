...
(define-instruction-set :sse2
  ...
  (:loads
   #+sb-unicode
   (u32.4-load-from-string #:movdqu u32.4 charvec char-array u32.4-string-ref u32.4-row-major-string-ref u32.4-string-sap-ref)
   (f64-load   #:movsd  f64   f64vec f64-array f64-aref   f64-row-major-aref f64-sap-ref)
   (f64.2-load #:movupd f64.2 f64vec f64-array f64.2-aref f64.2-row-major-aref f64.2-sap-ref)
   (u8.16-load #:movdqu u8.16  u8vec  u8-array u8.16-aref u8.16-row-major-aref u8.16-sap-ref)
   (u16.8-load #:movdqu u16.8 u16vec u16-array u16.8-aref u16.8-row-major-aref u16.8-sap-ref)
   (u32.4-load #:movdqu u32.4 u32vec u32-array u32.4-aref u32.4-row-major-aref u32.4-sap-ref)
   (u64.2-load #:movdqu u64.2 u64vec u64-array u64.2-aref u64.2-row-major-aref u64.2-sap-ref)
   (s8.16-load #:movdqu s8.16  s8vec  s8-array s8.16-aref s8.16-row-major-aref s8.16-sap-ref)
   (s16.8-load #:movdqu s16.8 s16vec s16-array s16.8-aref s16.8-row-major-aref s16.8-sap-ref)
   (s32.4-load #:movdqu s32.4 s32vec s32-array s32.4-aref s32.4-row-major-aref s32.4-sap-ref)
   (s64.2-load #:movdqu s64.2 s64vec s64-array s64.2-aref s64.2-row-major-aref s64.2-sap-ref))
  (:stores
   #+sb-unicode
   (u32.4-store-into-string #:movdqu u32.4 charvec char-array u32.4-string-ref u32.4-row-major-string-ref u32.4-string-sap-ref)
   (f64.2-store #:movupd f64.2 f64vec f64-array f64.2-aref f64.2-row-major-aref f64.2-sap-ref)
   (u8.16-store #:movdqu u8.16 u8vec u8-array u8.16-aref u8.16-row-major-aref u8.16-sap-ref)
   (u16.8-store #:movdqu u16.8 u16vec u16-array u16.8-aref u16.8-row-major-aref u16.8-sap-ref)
   (u32.4-store #:movdqu u32.4 u32vec u32-array u32.4-aref u32.4-row-major-aref u32.4-sap-ref)
   (u64.2-store #:movdqu u64.2 u64vec u64-array u64.2-aref u64.2-row-major-aref u64.2-sap-ref)
   (s8.16-store #:movdqu s8.16 s8vec s8-array s8.16-aref s8.16-row-major-aref s8.16-sap-ref)
   (s16.8-store #:movdqu s16.8 s16vec s16-array s16.8-aref s16.8-row-major-aref s16.8-sap-ref)
   (s32.4-store #:movdqu s32.4 s32vec s32-array s32.4-aref s32.4-row-major-aref s32.4-sap-ref)
   (s64.2-store #:movdqu s64.2 s64vec s64-array s64.2-aref s64.2-row-major-aref s64.2-sap-ref)
