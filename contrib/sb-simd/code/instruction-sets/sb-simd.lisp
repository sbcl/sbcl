...
(define-instruction-set :sb-simd
  ...
  (:reffers
   (f32 f32-array f32-aref f32-row-major-aref f32-sap-ref)
   (f64 f64-array f64-aref f64-row-major-aref f64-sap-ref)
   ( u8  u8-array  u8-aref  u8-row-major-aref  u8-sap-ref)
   (u16 u16-array u16-aref u16-row-major-aref u16-sap-ref)
   (u32 u32-array u32-aref u32-row-major-aref u32-sap-ref)
   (u64 u64-array u64-aref u64-row-major-aref u64-sap-ref)
   ( s8  s8-array  s8-aref  s8-row-major-aref  s8-sap-ref)
   (s16 s16-array s16-aref s16-row-major-aref s16-sap-ref)
   (s32 s32-array s32-aref s32-row-major-aref s32-sap-ref)
   (s64 s64-array s64-aref s64-row-major-aref s64-sap-ref))
  (:associatives
