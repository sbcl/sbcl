...
;;; block, we generally expect the CURRENT-CONFLICT to point at or
;;; before the block that we are looking at. If cyclic control flow
;;; causes the finger to overshoot our target block, we detect this
;;; and conservatively reset it to the head of the TN's
;;; conflicts. This allows us to quickly determine if there is a
