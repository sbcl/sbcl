...
(define-vop (unbind)
  ...
  (:generator 0
    ...
    (loadw tls-index symbol symbol-tls-index-slot other-pointer-lowtag)    
    (inst mov (make-ea :qword :base thread-base-tn :scale 1 :index tls-index) value)
...
(define-vop (unbind-to-here)
  ...
  (:generator 0
    ...
    #!+sb-thread (inst mov (make-ea :qword :base thread-base-tn :scale 1 :index tls-index) value)
    (storew 0 bsp (- binding-symbol-slot binding-size))
