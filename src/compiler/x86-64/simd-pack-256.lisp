             ...
             (let ((name (symbolicate "MOVE-FROM-AVX2/" type)))
               `(progn
                  (define-vop (,name)
                    ...
                    (:generator 13
                      (alloc-other simd-pack-256-widetag simd-pack-256-size y node temp thread-tn)
...
(define-vop (%make-simd-pack-256)
  ...
  (:generator 13
    (alloc-other simd-pack-256-widetag simd-pack-256-size dst node temp thread-tn)
    ;; see *simd-pack-element-types*
