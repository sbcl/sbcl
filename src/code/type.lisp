          ...
          (cond
            ((and left-low
                  ...
                  (cond ((and integerp
                        ...
                        ((and (not integerp)
                              (not (integerp open-right-low))
                              (sb-xc:>= (if (consp left-high)
                                            (car left-high)
                                            left-high)
                                        open-right-low)
                              (sb-xc:= (ceiling open-right-low)
            ...
            ((sb-xc:>= (or left-high
             ...
             (if (and (not integerp)
                 ...
                 (setf new-left-high (setf new-right-low (list (floor open-right-low))))
            ...
            ((consp right-low)
             (if (consp left-high)
                 ...
                 (when (sb-xc:< (car right-low)
                                left-high)
                   (setf new-right-low
                         (setf new-left-high (list left-high))))))
            ((sb-xc:<= (or right-low
             ...
             (if (and (not integerp)
                      ...
                      (sb-xc:> (floor open-right-high)
                               (floor open-left-high)))
                 (setf new-left-high (setf new-right-low (list (ceiling open-left-high))))
