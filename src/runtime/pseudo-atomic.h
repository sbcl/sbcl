...
#elif (defined(LISP_FEATURE_ARM) || defined LISP_FEATURE_ARM64) || defined LISP_FEATURE_RV32 && !defined LISP_FEATURE_SB_THREAD
static inline int
...
#if !defined LISP_FEATURE_ARM && !defined LISP_FEATURE_ARM64 && !defined LISP_FEATURE_RV32
