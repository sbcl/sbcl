...
const struct {
  __attribute__((aligned((2*N_WORD_BYTES)))) lispobj header;
  lispobj len;
  char c;
} strings_for_digits[] = {
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '0' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '1' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '2' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '3' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '4' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '5' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '6' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '7' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '8' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, '9' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'A' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'B' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'C' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'D' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'E' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'F' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'G' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'H' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'I' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'J' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'K' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'L' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'M' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'N' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'O' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'P' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'Q' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'R' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'S' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'T' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'U' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'V' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'W' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'X' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'Y' },
  {SIMPLE_BASE_STRING_WIDETAG, 1<<N_FIXNUM_TAG_BITS, 'Z' },
};
