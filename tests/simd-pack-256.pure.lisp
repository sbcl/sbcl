...
(with-test (:name (simd-pack-256 subtypep :smoke))
  (assert-tri-eq t t (subtypep '(simd-pack-256 integer) 'simd-pack-256))
  ...
  (assert-tri-eq nil t (subtypep 'simd-pack-256 '(simd-pack-256 integer)))
  ...
  (assert-tri-eq t t (subtypep '(simd-pack-256 integer)
                               '(or (simd-pack-256 integer) (simd-pack-256 single-float))))
  (assert-tri-eq t t (subtypep '(simd-pack-256 integer)
                               '(or (simd-pack-256 integer) (simd-pack-256 double-float))))
  (assert-tri-eq nil t (subtypep '(simd-pack-256 integer)
                                 '(or (simd-pack-256 single-float) (simd-pack-256 double-float))))
  (assert-tri-eq nil t (subtypep '(or (simd-pack-256 integer) (simd-pack-256 single-float))
                                 '(simd-pack-256 integer)))
  (assert-tri-eq nil t (subtypep '(or (simd-pack-256 integer) (simd-pack-256 double-float))
                                 '(simd-pack-256 integer)))
