...
../../run-sbcl.sh --disable-ldb --lose-on-corruption \
 ...
 "REMOVE-DUPLICATES.FOLD.2" "REMOVE-DUPLICATES.FOLD.1" "REMOVE-IF-NOT.FOLD.4"
 "REMOVE-IF-NOT.FOLD.3" "REMOVE-IF-NOT.FOLD.2" "REMOVE-IF-NOT.FOLD.1"
 "REMOVE-IF.FOLD.4" "REMOVE-IF.FOLD.3" "REMOVE-IF.FOLD.2" "REMOVE-IF.FOLD.1"
 "REMOVE.FOLD.4" "REMOVE.FOLD.3" "REMOVE.FOLD.2" "REMOVE.FOLD.1"
 "SUBSTITUTE-IF-NOT.FOLD.4" "SUBSTITUTE-IF-NOT.FOLD.3"
