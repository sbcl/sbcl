...
(test-util:with-test (:name :apx-extended-registers-and-instructions)
  (let ((r16 (sb-x86-64-asm::get-gpr :qword 16))
    ...
    (test-assemble `(add-ndd ,r16 ,r17 ,r18)
                   "62ECFC1001D1     ADD R16, R17, R18")
    (test-assemble `(add-ndd ,r16 ,r17 ,r18 :nf 1)
                   "62ECFC1401D1     {nf} ADD R16, R17, R18")
    (test-assemble `(sub-ndd ,r19 ,r20 42)
                   "62FCE41083EC2A   SUB R19, R20, 42")
    (test-assemble `(xor-ndd ,r21 ,r22 ,r23)
                   "62ECD41031FE     XOR R21, R22, R23")
    (test-assemble `(imul-ndd ,r24 ,r25 ,r26)
                   "624CBC10AFD1     IMUL R24, R25, R26")
    (test-assemble `(shl-ndd ,r16 ,r17 10)
                   "62FCFC10C1E10A   SHL R16, R17, 10")
    (test-assemble `(push2 ,r16 ,r17)
                   "62FC7C10FFF1     PUSH2 R16, R17")
    (test-assemble `(pop2 ,r16 ,r17)
                   "62FC7C108FC1     POP2 R16, R17")
    (test-assemble `(ccmp :e ,r16 ,r17 0)
                   "62EC840439C8     CCMPE R16, R17, 0")
    (test-assemble `(ctest :ne ,r16 ,r17 0)
                   "62EC840585C8     CTESTNE R16, R17, 0")
    (test-assemble `(cfcmov :e ,r16 ,r17)
                   "62ECFC0844C1     CFCMOVE R16, R17")))
