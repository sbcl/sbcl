...
(with-test (:name (simd-pack subtypep :smoke))
  ...
  (assert-tri-eq t t (subtypep '(simd-pack integer)
                               '(or (simd-pack integer) (simd-pack single-float))))
  (assert-tri-eq t t (subtypep '(simd-pack integer)
                               '(or (simd-pack integer) (simd-pack double-float))))
  (assert-tri-eq nil t (subtypep '(simd-pack integer)
                                 '(or (simd-pack single-float) (simd-pack double-float))))
  (assert-tri-eq nil t (subtypep '(or (simd-pack integer) (simd-pack single-float))
                                 '(simd-pack integer)))
  (assert-tri-eq nil t (subtypep '(or (simd-pack integer) (simd-pack double-float))
                                 '(simd-pack integer)))
