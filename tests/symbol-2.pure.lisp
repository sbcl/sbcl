...
(defparameter *cl-classification*
  '(&ALLOW-OTHER-KEYS 0 &AUX 0 &BODY 0 &ENVIRONMENT 0 &KEY 0 &OPTIONAL 0 &REST 0
    ...
    *LOAD-VERBOSE* 1 *MACROEXPAND-HOOK* 1 *MODULES* 1 CL:*PACKAGE* 1 *PRINT-ARRAY* 1
    ...
    *STANDARD-INPUT* 1 *STANDARD-OUTPUT* 1 *TERMINAL-IO* 1 *TRACE-OUTPUT* 1 + 3 ++
    ...
    ARRAY-HAS-FILL-POINTER-P 2 ARRAY-IN-BOUNDS-P 2 ARRAY-RANK 2 ARRAY-RANK-LIMIT
    5 ARRAY-ROW-MAJOR-INDEX 2 ARRAY-TOTAL-SIZE 2 ARRAY-TOTAL-SIZE-LIMIT 5 ARRAYP
    ...
    CELL-ERROR-NAME 2 CERROR 2 CHANGE-CLASS 2 CHAR 2 CHAR-CODE 2 CHAR-CODE-LIMIT
    ...
    CL:DEFMETHOD 2 DEFPACKAGE 2 DEFPARAMETER 2 DEFSETF 2 DEFSTRUCT 2 DEFTYPE 2 DEFUN
    ...
    FIRST 2 FIXNUM 8 FLET 2 FLOAT 10 FLOAT-DIGITS 2 FLOAT-PRECISION 2 FLOAT-RADIX
    2 FLOAT-SIGN 2 FLOATING-POINT-INEXACT 8 FLOATING-POINT-INVALID-OPERATION 8
    ...
    IGNORE-ERRORS 2 IMAGPART 2 IMPORT 2 CL:IN-PACKAGE 2 INCF 2 INITIALIZE-INSTANCE 2
    ...
    PATHNAME-DEVICE 2 PATHNAME-DIRECTORY 2 PATHNAME-HOST 2 PATHNAME-MATCH-P 2
    PATHNAME-NAME 2 PATHNAME-TYPE 2 PATHNAME-VERSION 2 PATHNAMEP 2 PEEK-CHAR 2
