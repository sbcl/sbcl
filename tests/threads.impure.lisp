...
(with-test (:name (:funcallable-instances)
  ...
  (let ((fun (sb-kernel:%make-funcallable-instance 0))
        (condition nil))
    (sb-pcl:set-funcallable-instance-function fun #'closure-one)
    (flet ((changer ()
             (loop (sb-pcl:set-funcallable-instance-function fun #'closure-one)
                   (sb-pcl:set-funcallable-instance-function fun #'closure-two)))
           (test ()
